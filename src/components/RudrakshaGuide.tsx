...
export function RudrakshaGuide() {
  ...
  return (
    <section className="py-14 sm:py-20 lg:py-24 bg-gradient-to-b from-[#0E1B26] via-[#162A3B] to-[#0E1B26] text-peach min-h-screen relative overflow-hidden border-b border-orange/20">
